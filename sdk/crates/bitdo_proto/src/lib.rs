...
#[cfg(feature = "hidapi-backend")]
pub use hid_transport::{EnumeratedDevice, HidTransport, enumerate_hid_devices};
pub use profile::ProfileBlob;
pub use registry::{
    CommandRegistryRow, PidRegistryRow, command_registry, device_profile_for, find_command,
    find_pid, pid_registry,
};
pub use session::{
    CommandExecutionReport, DeviceSession, DiagCommandStatus, DiagProbeResult, DiagSeverity,
