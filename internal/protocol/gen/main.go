...
// from docs/spec/command_matrix.csv and docs/spec/pid_matrix.csv. Those CSVs are the
...
func renderGo(commands []commandRow, commandOrder []string, pids []pidRow) ([]byte, error) {
	...
	b.WriteString("// Code generated by internal/protocol/gen from docs/spec/command_matrix.csv and\n")
	b.WriteString("// docs/spec/pid_matrix.csv. DO NOT EDIT — edit the spec CSVs and re-run\n")
	b.WriteString("// `go generate ./...` instead.\n\n")
	b.WriteString("package protocol\n\n")

	b.WriteString("// CommandID constants, one per unique command_id in docs/spec/command_matrix.csv,\n")
	...
	b.WriteString("// CommandRegistry is generated from docs/spec/command_matrix.csv.\n")
